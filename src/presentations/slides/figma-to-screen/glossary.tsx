...
const TERMS: Array<{ term: string; def: string; color: string }> = [
    ...
    { term: "T1 / T2 gate",        def: "T1 = blocks the run (build, lint, imports, DI). T2 = warns but lets you ship (L10n, SwiftGen, copyright).",          color: C.red },
    { term: "MARK anchor",         def: "// MARK: comments the patcher uses as insertion points in central files (Destination.swift, Injection.swift).",     color: P },
