    ...
    return (
        <section id="s-future" style={{ background: C.surface, borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`, padding: "96px 48px" }}>
            <div style={{ maxWidth: 1200, margin: "0 auto" }}>
                <Reveal>
                    <SectionLabel color={P}>WHAT’S COMING</SectionLabel>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16, marginBottom: 32 }}>
                    <FeatureCard
                        ...
                        color={P}
                        delay={0}
                        description="Since March 2024: alternative app stores in EU. Alternative payment processors. Browser engine choice (WebKit is no longer mandatory). Apple charges a Core Technology Fee (€0.50/install over 1M). Pressure is building on Apple to extend these rights globally — UK CMA and US DOJ have similar cases pending."
                    ...
                    <FeatureCard
                        ...
                        color={C.red}
                        delay={0.08}
                        description="The largest US antitrust case against Apple. Charges: super apps, streaming game bans, smartwatch lock-in, messaging lock-in (Beeper cited), digital wallet tap-to-pay. Trial likely 2026–2027. If Apple loses — sideloading in the US, interoperability requirements, possible break-up of App Store from hardware. Multi-year shift."
                    ...
                    <FeatureCard
                        ...
                        color={C.purple}
                        delay={0.16}
                        description="Guideline 4.7 now explicitly covers generative AI. Apps must surface content moderation, prevent CSAM, label AI-generated content, give users the ability to report. New Guideline 4.3 also targets 'AI app template' spam — the Wordle effect applied to GPT wrappers."
                    ...
                    <FeatureCard
                        ...
                        color={C.accent}
                        delay={0.24}
                        description="New platform review bar for Vision Pro (currently ~95% rejection for iPad-compat apps that don't adapt). App Intents now REQUIRED to be discoverable by Siri & Apple Intelligence — apps without them deprioritized in Spotlight, Shortcuts, and AI-driven flows. Major refactor in 2025–2026."
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
                    <CalloutBox color={P} icon="📈" label="WHAT TO WATCH FOR">
                        ...
                        <b>Q4 2026:</b> EU DMA anniversary — Apple may face fines if compliance is deemed insufficient. <br />
                        <b>Ongoing:</b> WWDC each June introduces 5–20 new guidelines. <br />
                    ...
                    <CalloutBox color={C.yellow} icon="🧭" label="HOW WE STAY AHEAD">
                        ...
                        <b>2.</b> Read WWDC ‘What’s new in App Store Connect’ every year. <br />
