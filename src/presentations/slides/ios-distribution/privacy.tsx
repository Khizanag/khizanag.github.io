                    ...
                    <div>
                        <CalloutBox color={C.red} icon="⚠" label="REQUIRED REASON APIS">
                            ...
                            <ul style={{ margin: "12px 0 0 20px", color: C.muted, fontSize: 12, lineHeight: 1.8 }}>
                                <li><b>UserDefaults</b> &mdash; accessing user preferences</li>
                            ...
                            Reasons are 4-character codes. &lsquo;CA92.1&rsquo; = 'Access info from same app only.' Wrong reason = rejection.
                        </CalloutBox>
                        ...
                        <div style={{ marginTop: 16 }}>
                            <CalloutBox color={C.accent} icon="✅" label="BANKING EXTRAS">
                                ...
                                <ul style={{ margin: "12px 0 0 20px", color: C.muted, fontSize: 12, lineHeight: 1.8 }}>
                                    <li><b>PSD2 / SCA</b> &mdash; Strong Customer Authentication</li>
