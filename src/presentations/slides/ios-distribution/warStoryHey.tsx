        ...
        <section id="s-war-hey" style={{ background: C.surface, borderTop: `1px solid ${C.border}`, borderBottom: `1px solid ${C.border}`, padding: "96px 48px" }}>
            <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                ...
                <div style={{ background: C.bg, border: `1px solid ${C.border}`, borderRadius: 16, padding: "32px 40px", marginBottom: 24 }}>
                    ...
                    <TimelineRow when="Jun 16" title="v1.0.1 bug-fix submitted" detail="Apple rejects under Guideline 3.1.1 — ‘app must use IAP to unlock features.’ Basecamp points out that they've been following this exact pattern for 8 years with Basecamp." color={C.yellow} delay={0.1} />
                    <TimelineRow when="Jun 18" title="DHH goes public on Twitter" detail="“Apple just doubled down on their rejection of HEY's ability to provide bug fixes and new features.” Thread goes viral. DHH coins ‘Apple's highway robbery.’" color={C.red} delay={0.2} />
                    <TimelineRow when="Jun 19" title="Apple doubles down" detail="Phil Schiller gives an interview: “We're proud of the review process.” Reviewer calls Basecamp: ‘You can stay if you add IAP.’" color={C.red} delay={0.3} />
                    ...
                    <TimelineRow when="Jun 26" title="Resolution: ‘free trial’ version" detail="Basecamp adds a 14-day free trial inside the app. No IAP, but enough in-app functionality to clear Guideline 2.1. Apple approves. HEY ships." color={C.accent} delay={0.5} />
                </div>
                ...
                <CalloutBox color={P} icon="🎓" label="WHAT THIS TEACHES US">
                    <b>Apple reversed a guideline interpretation under public pressure.</b> Consequences: (1) bug-fix rejections restricted, (2) ‘Reader app’ rules formalized in 2021 — now covers Netflix, Spotify, and yes, banking apps like ours, (3) direct trigger for every ‘30% tax’ conversation that followed, including Epic and EU DMA.
                </CalloutBox>
            </div>
        </section>
    );
